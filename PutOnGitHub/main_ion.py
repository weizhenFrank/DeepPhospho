...
from IonInten.data_dataset.dataset import IonDataset, collate_fn, RandomMaskingDataset
from IonInten.utils.eval import eval
from torch.utils.data import DataLoader
from RT_pipline.utli.logger import MetricLogger, setup_logger, TFBoardWriter
from RT_pipline.eval import pretrain_eval

from IonInten.utils.lr_scheduler import make_lr_scheduler
from IonInten.models.EnsembelModel import CNN_LSTM_Transformer, LSTMTransformer, CNNTransformerModel
from IonInten.utils.utils_functions import copy_files, get_loss, show_params_status, get_parser
from IonInten.utils.model_param_load_original import save_checkpoint, load_param_from_file
...
def main():
    ...
    copy_files("IonInten/models/model.py", output_dir)
    copy_files("IonInten/models/EnsembelModel.py", output_dir)
    copy_files("main_ion.py", output_dir)
    copy_files("IonInten/configs", output_dir)
