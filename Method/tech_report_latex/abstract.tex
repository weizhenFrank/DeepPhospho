\begin{abstract}
   ...
   Here, we propose
   our new method based on LSTM + Transformer model and focus on the phosphorylation peptide data, especially.
   Using our model, we could build a larger and more
