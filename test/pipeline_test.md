...
```shell
python ./run_deep_phospho.py -w ./test/TestPipeline-ExistIon_AllRT_Ensemble_PredOnly -t Test-ExistIon_AllRT_Ensemble_PredOnly -pf ./test/PipelineTestData/PredInput-Format_MQ1.6.txt -pt MQ1.6 -pf ./test/PipelineTestData/PredInput-Format_PepDP.txt -pt PepDP -d 0 -ie 2 -re 2 -ibs 128 -rbs 128 -lr 0.0001 -ml 74 -rs *-100,200 -en -no_time -m -pretrain_ion ./test/TestPipeline-GeneralUsage/TestGeneralUsage-IonModel/ckpts/best_model.pth -pretrain_rt_4 ./test/TestPipeline-GeneralUsage/TestGeneralUsage-RTModel-4/ckpts/best_model.pth -pretrain_rt_5 ./test/TestPipeline-GeneralUsage/TestGeneralUsage-RTModel-5/ckpts/best_model.pth -pretrain_rt_6 ./test/TestPipeline-GeneralUsage/TestGeneralUsage-RTModel-6/ckpts/best_model.pth -pretrain_rt_7 ./test/TestPipeline-GeneralUsage/TestGeneralUsage-RTModel-7/ckpts/best_model.pth -pretrain_rt_8 ./test/TestPipeline-GeneralUsage/TestGeneralUsage-RTModel-8/ckpts/best_model.pth
```
