...
- [DeepPhospho: impoves spectral library generation for DIA phosphoproteomics](#deepphospho-impoves-spectral-library-generation-for-dia-phosphoproteomics)
  - [Contents](#contents)
- [Setup DeepPhospho](#setup-deepphospho)
  - [Basic steps](#basic-steps)
    - [Get DeepPhospho](#get-deepphospho)
    - [Setup python environment](#setup-python-environment)
  - [Optional steps](#optional-steps)
    - [Download pre-trained model parameters](#download-pre-trained-model-parameters)
    - [Use GPU](#use-gpu)
  - [Use DeepPhospho desktop with graphical interface](#use-deepphospho-desktop-with-graphical-interface)
- [Examples (DeepPhospho runner and desktop)](#examples-deepphospho-runner-and-desktop)
  - [Example 1 (complete pipeline for training and prediction)](#example-1-complete-pipeline-for-training-and-prediction)
  - [Example 2 (use existed model weight files to do prediction without training and turn off RT ensemble)](#example-2-use-existed-model-weight-files-to-do-prediction-without-training-and-turn-off-rt-ensemble)
- [Introduce to DeepPhospho runner](#introduce-to-deepphospho-runner)
  - [Runner supported training data formats](#runner-supported-training-data-formats)
  - [Runner supported prediction data formats](#runner-supported-prediction-data-formats)
  - [Description of runner arguments](#description-of-runner-arguments)
  ...
  - [Example](#example)
- [DeepPhospho configs](#deepphospho-configs)
  - [Configs for ion intensity model](#configs-for-ion-intensity-model)
  - [Configs for RT model](#configs-for-rt-model)
  - [Use config file and overwrite values with command line arguments](#use-config-file-and-overwrite-values-with-command-line-arguments)
- [Train and predict manually](#train-and-predict-manually)
  - [Start demo for model training](#start-demo-for-model-training)
  - [Prepare customized training data](#prepare-customized-training-data)
  - [Start  demo for prediction](#start--demo-for-prediction)
  - [Prepare customized prediction input](#prepare-customized-prediction-input)
  - [Generate ready to use spectral library](#generate-ready-to-use-spectral-library)
- [License](#license)
...
- Currently, runner supports the following training data formats
  ...
  - EasyPQP - Tsv file generated from EasyPQP. This needs "Annotation" column correctly filled with formats like `y5^2` and `y5-H3O4P1^2`
...
- Currently, runner supports the following prediction data formats
  ...
  5. EasyPQP - tsv file generated by EasyPQP
  6. PepSN13 - Spectronaut 13+ peptide format like \_[Acetyl (Protein N-term)]M[Oxidation (M)]LSLS[Phospho (STY)]PLK\_
  7. PepMQ1.5 - MaxQuant 1.5- peptide format like \_(ac)GS(ph)QDM(ox)GS(ph)PLRET(ph)RK\_
  8. PepMQ1.6 - MaxQuant 1.6+ peptide format like \_(Acetyl (Protein N-term))TM(Oxidation (M))DKS(Phospho (STY))ELVQK\_
  9. PepUniMod - UniMod peptide format like (UniMod:1)AHAC(UniMod:4)WPS(UniMod:21)PYM(UniMod:35)K
  10. PepComet - Comet peptide format like n#DFM\*SPKFS@LT@DVEY@PAWCQDDEVPITM\*QEIR
  11. PepDP - DeepPhospho used peptide format like *1ED2MCLK
- [notice]
...
- `-min_frags` or `--min_frag_per_prec`
...
- `-max_frags` or `--max_frag_per_prec`
